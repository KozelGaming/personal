...
install_pteroq() {
  ...
  service enable pteroq.service
  service start pteroq
...
enable_services_debian_based() {
  service enable mariadb
  service enable redis-server
...
firewall_firewalld() {
  ...
  # Enable
  service --now enable firewalld >/dev/null # Enable and start
